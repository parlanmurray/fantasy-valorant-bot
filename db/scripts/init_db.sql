...
CREATE TABLEIF NOT EXISTS FantasyValDev.events
(
	id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE USER IF NOT EXISTS 'discord'@'localhost' IDENTIFIED BY MARIADB_PASSWORD;
GRANT DELETE, INSERT, UPDATE ON 'FantasyValDev.*' TO 'discord'@'localhost';
GRANT DELETE, INSERT, UPDATE ON 'FantasyValDProd.*' TO 'discord'@'localhost';
FLUSH PRIVILEGES;
