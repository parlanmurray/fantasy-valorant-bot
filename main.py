...
def main():
	...
	parser.add_argument('-r', '--rounds', 'num_rounds', action='store', default=7, type=int, help="number of draft rounds")
	parser.add_argument('-s', '--subs', 'sub_slots', action='store', default=1, type=int, help="number of sub slots allowed per team")
